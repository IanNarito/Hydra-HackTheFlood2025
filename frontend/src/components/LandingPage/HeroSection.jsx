 ...
 * Card component for the Anonymous Civic Dropbox feature
 * Includes "Submit Evidence" button linking to /dropbox route with fade transition
 * 
  ...
  return (
    ...
    >
      ...
      <h3 className="font-play font-bold text-[#d9d9d9] text-xl md:text-2xl 
        ...
        Anonymous Civic Dropbox
      </h3>

      {/* Description */}
      <p className="font-inter text-[#a0a0a0] text-sm md:text-base
                    leading-relaxed mb-6 md:mb-8">
        We provide an anonymous, end-to-end encrypted channel for whistleblowers and concerned citizens to submit documents, photos, and evidence without fear of retaliation.
      </p>
      ...
      <a
        ...
        aria-label="Submit evidence to the Anonymous Civic Dropbox"
      >
        Submit Evidence
      </a>
    </div>
